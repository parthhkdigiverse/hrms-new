...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$39(_objectSpread$39({}, _objectWithoutProperties$19(_ref, _excluded$19)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (cx === +cx && cy === +cy && size === +size) return /*#__PURE__*/ import_react.createElement("path", _extends$33({}, filteredProps, {
...
function _callSuper$21(t, o, e) {
	return o = _getPrototypeOf$21(o), _possibleConstructorReturn$21(t, _isNativeReflectConstruct$21() ? Reflect.construct(o, e || [], _getPrototypeOf$21(t).constructor) : o.apply(t, e));
}
...
var DefaultLegendContent = /*#__PURE__*/ function(_PureComponent) {
	function DefaultLegendContent() {
		_classCallCheck$24(this, DefaultLegendContent);
		return _callSuper$21(this, DefaultLegendContent, arguments);
	}
	_inherits$21(DefaultLegendContent, _PureComponent);
	return _createClass$24(DefaultLegendContent, [
		{
			key: "renderIcon",
			value: 
			/**
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					return /*#__PURE__*/ import_react.createElement("li", _extends$32({
						className,
						style: itemStyle,
...
var Legend = /*#__PURE__*/ function(_PureComponent) {
	function Legend() {
		var _this;
		_classCallCheck$23(this, Legend);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$20(this, Legend, [].concat(args));
	...
	_inherits$20(Legend, _PureComponent);
	return _createClass$23(Legend, [
		{
...
var TooltipBoundingBox = /*#__PURE__*/ function(_PureComponent) {
	function TooltipBoundingBox() {
		var _this;
		_classCallCheck$22(this, TooltipBoundingBox);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$19(this, TooltipBoundingBox, [].concat(args));
	...
	_inherits$19(TooltipBoundingBox, _PureComponent);
	return _createClass$22(TooltipBoundingBox, [
		{
			key: "updateBBox",
			value: function updateBBox() {
				if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
...
var Tooltip = /*#__PURE__*/ function(_PureComponent) {
	function Tooltip() {
		_classCallCheck$21(this, Tooltip);
		return _callSuper$18(this, Tooltip, arguments);
	}
	_inherits$18(Tooltip, _PureComponent);
	return _createClass$21(Tooltip, [{
		key: "render",
		value: function render() {
			var _this = this;
...
var DecimalCSS = /*#__PURE__*/ function() {
	function DecimalCSS(num, unit) {
		_classCallCheck$20(this, DecimalCSS);
		this.num = num;
		this.unit = unit;
		this.num = num;
		this.unit = unit;
	...
	return _createClass$20(DecimalCSS, [
		{
			key: "add",
...
var Text = function Text(_ref5) {
	...
	return /*#__PURE__*/ import_react.createElement("text", _extends$30({}, filterProps(textProps, true), {
		x,
		y,
...
var ErrorBar = /*#__PURE__*/ function(_React$Component) {
	function ErrorBar() {
		...
		return _callSuper$17(this, ErrorBar, arguments);
	}
	_inherits$17(ErrorBar, _React$Component);
...
var appendOffsetOfLegend = function appendOffsetOfLegend(offset, _unused, props, legendBox) {
	...
	if (legendProps) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$30(_objectSpread$30({}, offset), {}, _defineProperty$34({}, align, offset[align] + (boxWidth || 0)));
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$30(_objectSpread$30({}, offset), {}, _defineProperty$34({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
	}
	return offset;
};
...
var _excluded$14 = ["valueAccessor"];
var _excluded2$6 = [
	"data",
	"dataKey",
	"clockWise",
...
var Sector = function Sector(sectorProps) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$26({}, filterProps(props, true), {
		className: layerClass,
		d: path,
		role: "img"
	}));
...
var Rectangle = function Rectangle(rectangleProps) {
	...
	if (!isUpdateAnimationActive) return /*#__PURE__*/ import_react.createElement("path", _extends$24({}, filterProps(props, true), {
		className: layerClass,
	...
	return /*#__PURE__*/ import_react.createElement(es6_default, {
		...
		}, /*#__PURE__*/ import_react.createElement("path", _extends$24({}, filterProps(props, true), {
			className: layerClass,
...
var Dot = function Dot(props) {
	...
	if (cx === +cx && cy === +cy && r === +r) return /*#__PURE__*/ import_react.createElement("circle", _extends$22({}, filterProps(props, false), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var PolarAngles = function PolarAngles(props) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-angle" }, polarAngles.map(function(entry) {
		...
		return /*#__PURE__*/ import_react.createElement("line", _extends$20({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle(props) {
	...
	return /*#__PURE__*/ import_react.createElement("circle", _extends$20({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon(props) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$20({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath(props) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-concentric" }, polarRadius.map(function(entry, i) {
		var key = i;
		if (gridType === "circle") return /*#__PURE__*/ import_react.createElement(ConcentricCircle, _extends$20({ key }, props, {
			radius: entry,
			index: i
		}));
		return /*#__PURE__*/ import_react.createElement(ConcentricPolygon, _extends$20({ key }, props, {
			radius: entry,
			index: i
		}));
	}));
...
var PolarGrid = function PolarGrid(_ref) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid" }, /*#__PURE__*/ import_react.createElement(PolarAngles, _extends$20({
		cx,
		cy,
		innerRadius,
		outerRadius,
		gridType,
		radialLines
	}, props)), /*#__PURE__*/ import_react.createElement(ConcentricPath, _extends$20({
		cx,
		cy,
		innerRadius,
		outerRadius,
...
var PolarRadiusAxis = /*#__PURE__*/ function(_PureComponent) {
	function PolarRadiusAxis() {
		_classCallCheck$18(this, PolarRadiusAxis);
		return _callSuper$16(this, PolarRadiusAxis, arguments);
	}
	_inherits$16(PolarRadiusAxis, _PureComponent);
	return _createClass$18(PolarRadiusAxis, [
		{
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				return /*#__PURE__*/ import_react.createElement("line", _extends$19({ className: "recharts-polar-radius-axis-line" }, props));
			}
		},
		{
			key: "renderTicks",
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$19({}, props, { className: "recharts-polar-radius-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$25(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty$25(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty$25(PolarRadiusAxis, "defaultProps", {
	type: "number",
	radiusAxisId: 0,
	cx: 0,
	cy: 0,
...
var PolarAngleAxis = /*#__PURE__*/ function(_PureComponent) {
	function PolarAngleAxis() {
		_classCallCheck$17(this, PolarAngleAxis);
		return _callSuper$15(this, PolarAngleAxis, arguments);
	}
	_inherits$15(PolarAngleAxis, _PureComponent);
	return _createClass$17(PolarAngleAxis, [
		{
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				if (axisLineType === "circle") return /*#__PURE__*/ import_react.createElement(Dot, _extends$18({ className: "recharts-polar-angle-axis-line" }, props, {
					cx,
					cy,
					r: radius
				}));
				...
				return /*#__PURE__*/ import_react.createElement(Polygon, _extends$18({ className: "recharts-polar-angle-axis-line" }, props, { points }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks() {
				...
				var items = ticks.map(function(entry, i) {
					...
					return /*#__PURE__*/ import_react.createElement(Layer, _extends$18({
						...
						key: "tick-".concat(entry.coordinate)
					}, adaptEventsOfChild(_this.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$18({ className: "recharts-polar-angle-axis-tick-line" }, tickLineProps, lineCoord)), tick && PolarAngleAxis.renderTickItem(tick, tickProps, tickFormatter ? tickFormatter(entry.value, i) : entry.value));
				});
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$18({}, props, { className: "recharts-polar-angle-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$24(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty$24(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty$24(PolarAngleAxis, "defaultProps", {
	type: "category",
	angleAxisId: 0,
	scale: "auto",
	cx: 0,
...
var Trapezoid = function Trapezoid(props) {
	...
	if (!isUpdateAnimationActive) return /*#__PURE__*/ import_react.createElement("g", null, /*#__PURE__*/ import_react.createElement("path", _extends$17({}, filterProps(trapezoidProps, true), {
		className: layerClass,
	...
	return /*#__PURE__*/ import_react.createElement(es6_default, {
		...
		return /*#__PURE__*/ import_react.createElement(es6_default, {
			...
			duration: animationDuration,
			easing: animationEasing
		}, /*#__PURE__*/ import_react.createElement("path", _extends$17({}, filterProps(trapezoidProps, true), {
			className: layerClass,
...
var Pie = /*#__PURE__*/ function(_PureComponent) {
	function Pie(props) {
		var _this;
		_classCallCheck$16(this, Pie);
		_this = _callSuper$14(this, Pie, [props]);
	...
	_inherits$14(Pie, _PureComponent);
	return _createClass$16(Pie, [
		{
			key: "isActiveIndex",
...
//#endregion
export { PolarGrid as _, BarChart as a, Tooltip as b, XAxis as c, CartesianGrid as d, Bar as f, PolarRadiusAxis as g, PolarAngleAxis as h, PieChart as i, Area as l, Pie as m, AreaChart as n, LineChart as o, Radar as p, RadarChart as r, YAxis as s, ComposedChart as t, Line as u, Cell as v, Legend as x, ResponsiveContainer as y };
